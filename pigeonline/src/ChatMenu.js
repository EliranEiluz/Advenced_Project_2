    ...
    <div className="inbox_people">
      <div className="headind_bar row">
        <div className="exit col-2">
          <Link to="/"><button className="exitBut">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-arrow-down-left-square-fill" viewBox="0 0 16 16">
