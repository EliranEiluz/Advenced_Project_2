...
function SampleChat() {
  ...
  <div className="inbox_msg">
    ...
    <div className="mesgs">
      ...
      <div className='col-xl-1 col-sm-2 col-xs-3' id='sendBut'>
      <button className="SendButton msg_send_btn" type="button">
            ...
            <div className='col-xl-1 col-sm-2 col-xs-3' id='dropUpCol'>
            ...
            <div className='col-xl-10 col-sm-8 col-xs-6' id='inputRow'>
