...
function DropUp({newPictureMessage, newVideoMessage, startRecord, newRecordMessage}) {
    ...
    return(
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          ...
          <p>
            <button id="btnStart" onClick={startRecord}>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-record-circle" viewBox="0 0 16 16">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;
            <button id="btnStop">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-stop-circle" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
